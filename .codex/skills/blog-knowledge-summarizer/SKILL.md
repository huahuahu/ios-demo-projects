...
description: Use this project-local skill when the user asks Codex to write, outline, expand, polish, or summarize a blog post from learning notes, demo projects, source code, experiments, screenshots, transcripts, or rough Chinese/English thoughts. Prefer a blog-length technical summary that extracts what was learned, explains why it matters, and connects the content to this repository's demos or blog workflow.
---
...
- **Skill or prompt summary**: when the user asks to summarize a reusable writing skill, produce concise instructions that can become or update a Codex skill.
